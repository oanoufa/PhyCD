...
def apply_masking(sample_list,
    ...
    path_mut_file = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/maple_mutations_batch{batch_id}_{param_term}.tsv"
    with open(path_mut_file, "w") as f:
        f.write("sample_name\tmasked_mutations_masked\tmasked_mutations_random\n")

    clean_tree_files_path = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/clean_tree_batch{batch_id}_{param_term}.maple"

    maple_alignment_unmasked_file_path = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/unmasked_alignment_batch{batch_id}_{param_term}.maple"
    maple_alignment_random_file_path = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/random_alignment_batch{batch_id}_{param_term}.maple"
    maple_alignment_masked_file_path = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/masked_alignment_batch{batch_id}_{param_term}.maple"

    path_store_n_masked = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/n_masked_batch_{batch_id}_{param_term}.tsv"
...
if __name__ == "__main__":
    ...
    print(param_term)
    path_write_file = f"/nfs/research/goldman/anoufa/data/MAPLE_input/1_batches/maple_alignment_batch{batch_id}_{param_term}.maple"
