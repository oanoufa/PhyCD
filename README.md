...
The *dropout masked* alignment augmented with the reference genomes, the list of all flagged putatively contaminated samples and the reference phylogenetic tree generated by the pipeline with default parameters (0.05, 0, 0.10, 3) are available on our [Zenodo repository]().
